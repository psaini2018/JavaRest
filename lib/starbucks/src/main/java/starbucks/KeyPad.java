...
public class KeyPad implements ITouchEventHandler, IDisplayComponent, IKeyPadSubject
{
    ...
    */
    ...
    /**
     * Checks if the inputs are completed.
     * @return Boolean value of completion status. Always true here
     */
    public Boolean isInputCompleted() { return true; }


    /**
     * Clears the input key count
     * @param status Not used.
     */
    public void clearInputs(Boolean status) { if(!status) countPinDigits = 0; }
    ...
    public void removeObserver( IKeyPadObserver obj )
    {
        ...
        if ( i >= 0 ) {
            observers.get(i).keyEventUpdate(0, " ") ;
            observers.remove(i);
        }
